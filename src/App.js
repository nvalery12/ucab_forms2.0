...
import CuentaConfig from './componentes/Configuracion-User/partes/CuentaConfig';
        ...
        <ThemeProvider theme={theme}>
          <UserProvider>
            ...
            >
              ...
              />
              <Route path='/manage_account' element={<UserConfig/>}/>
                
              <Route path="/forms/estadisticas/:id" element={
                <FormProvider>
                  <VerRespuesta/>
                </FormProvider>} />
              <Route
